...
conda activate seeker_env

# Get current directory to help establish paths
DIR="/groups/bhurwitz/tools/MARVEL"
OUTDIR="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/tool_envs/seeker"
INPUT="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/data/zenodo_archive/test_dataset/test.fa"
cd $DIR

predict-metagenome $INPUT
