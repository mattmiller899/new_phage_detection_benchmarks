...
CONT="/groups/bhurwitz/containers/genomad_latest.sif"
DB="/groups/bhurwitz/databases/genomad/genomad_db/"
OUTDIR="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/tool_envs/genomad"
INPUT="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/data/zenodo_archive/test_dataset/test.fa"
cd $OUTDIR

apptainer run $CONT end-to-end $INPUT $OUTDIR $DB -t 4
