...
conda activate ppr-meta_env

# Load any necessary modules
# module load my_modules

# Get current directory to help establish paths
DIR="/groups/bhurwitz/tools/PPR-Meta"
OUT_DIR="$PBS_SUBMIT_DIR"
cd $DIR

./PPR_Meta /xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/data/zenodo_archive/test_dataset/test.fa $OUT_DIR/results.csv
