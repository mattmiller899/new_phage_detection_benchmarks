...
conda activate inherit

# Load any necessary modules
# module load my_modules

# Get current directory to help establish paths
DIR="/groups/bhurwitz/tools/INHERIT"
OUTDIR="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/tool_envs/inherit"
cd $DIR

python IHT_predict.py --sequence test.fasta --withpretrain True --model INHERIT.pt --out $OUTDIR/out.txt
