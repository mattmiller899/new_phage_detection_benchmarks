...
DIR="/groups/bhurwitz/tools/PhaBOX"
OUTDIR="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/tool_envs/phamer"
INPUT="/xdisk/bhurwitz/mattmiller899/new_phage_detection_benchmarks/data/zenodo_archive/test_dataset/test.fa"
cd $DIR

python PhaMer_single.py --contigs test_contigs.fa --threads 8 --len 3000 --rootpth $OUTDIR --out out/ --dbdir database/ --parampth parameters/
